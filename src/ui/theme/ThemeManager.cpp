...
void ThemeManager::initializeThemes() {
    ...
    inventorModern.primary = QColor(0x2B78E4);
    inventorModern.primaryDark = QColor(0x1E5AA8);
    inventorModern.primaryLight = QColor(0x5A9DFF);
    inventorModern.background = QColor(0xF5F5F5);
    inventorModern.surface = QColor(0xFFFFFF);
    inventorModern.surfaceHover = QColor(0xF0F0F0);
    inventorModern.surfaceSelected = QColor(0xE3F2FD);
    inventorModern.textPrimary = QColor(0x212121);
    inventorModern.textSecondary = QColor(0x757575);
    inventorModern.textDisabled = QColor(0xBDBDBD);
    inventorModern.textOnPrimary = QColor(0xFFFFFF);
    inventorModern.border = QColor(0xD0D0D0);
    inventorModern.borderLight = QColor(0xE8E8E8);
    inventorModern.borderDark = QColor(0xB0B0B0);
    inventorModern.borderFocus = QColor(0x2B78E4);
    inventorModern.ribbonBackground = QColor(0xFFFFFF);
    inventorModern.ribbonTab = QColor(0xF5F5F5);
    inventorModern.ribbonTabSelected = QColor(0xFFFFFF);
    inventorModern.ribbonTabHover = QColor(0xEEEEEE);
    inventorModern.dockTitle = QColor(0xF0F0F0);
    inventorModern.dockTitleActive = QColor(0xE0E0E0);
    inventorModern.dockContent = QColor(0xFFFFFF);
    inventorModern.statusBar = QColor(0xFAFAFA);
    inventorModern.statusBarBorder = QColor(0xD0D0D0);
    inventorModern.button = QColor(0xFFFFFF);
    inventorModern.buttonHover = QColor(0xF5F5F5);
    inventorModern.buttonPressed = QColor(0xE0E0E0);
    inventorModern.buttonPrimary = QColor(0x2B78E4);
    inventorModern.buttonPrimaryHover = QColor(0x1E5AA8);
    inventorModern.inputBackground = QColor(0xFFFFFF);
    inventorModern.inputBorder = QColor(0xD0D0D0);
    inventorModern.inputBorderFocus = QColor(0x2B78E4);
    inventorModern.treeBackground = QColor(0xFFFFFF);
    inventorModern.treeItemHover = QColor(0xF5F5F5);
    inventorModern.treeItemSelected = QColor(0xE3F2FD);
    inventorModern.scrollbar = QColor(0xE0E0E0);
    inventorModern.scrollbarHandle = QColor(0xC0C0C0);
    inventorModern.scrollbarHandleHover = QColor(0xA0A0A0);
    themes_["InventorModern"] = inventorModern;
    
    // Dark Theme (optional)
    ColorPalette dark;
    dark.primary = QColor(0x64B5F6);
    dark.primaryDark = QColor(0x42A5F5);
    dark.primaryLight = QColor(0x90CAF9);
    dark.background = QColor(0x1E1E1E);
    dark.surface = QColor(0x2D2D2D);
    dark.surfaceHover = QColor(0x3D3D3D);
    dark.surfaceSelected = QColor(0x1E3A5F);
    dark.textPrimary = QColor(0xFFFFFF);
    dark.textSecondary = QColor(0xB0B0B0);
    dark.textDisabled = QColor(0x606060);
    dark.textOnPrimary = QColor(0x000000);
    dark.border = QColor(0x404040);
    dark.borderLight = QColor(0x303030);
    dark.borderDark = QColor(0x505050);
    dark.borderFocus = QColor(0x64B5F6);
    dark.ribbonBackground = QColor(0x2D2D2D);
    dark.ribbonTab = QColor(0x252525);
    dark.ribbonTabSelected = QColor(0x2D2D2D);
    dark.ribbonTabHover = QColor(0x353535);
    dark.dockTitle = QColor(0x252525);
    dark.dockTitleActive = QColor(0x353535);
    dark.dockContent = QColor(0x2D2D2D);
    dark.statusBar = QColor(0x252525);
    dark.statusBarBorder = QColor(0x404040);
    dark.button = QColor(0x2D2D2D);
    dark.buttonHover = QColor(0x3D3D3D);
    dark.buttonPressed = QColor(0x1D1D1D);
    dark.buttonPrimary = QColor(0x64B5F6);
    dark.buttonPrimaryHover = QColor(0x42A5F5);
    dark.inputBackground = QColor(0x2D2D2D);
    dark.inputBorder = QColor(0x404040);
    dark.inputBorderFocus = QColor(0x64B5F6);
    dark.treeBackground = QColor(0x2D2D2D);
    dark.treeItemHover = QColor(0x3D3D3D);
    dark.treeItemSelected = QColor(0x1E3A5F);
    dark.scrollbar = QColor(0x404040);
    dark.scrollbarHandle = QColor(0x606060);
    dark.scrollbarHandleHover = QColor(0x808080);
    themes_["Dark"] = dark;
}
